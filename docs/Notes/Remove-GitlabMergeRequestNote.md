...
### Example 2: Delete a comment from a merge request in a specific project

```powershell
Remove-GitlabMergeRequestNote -ProjectId 'mygroup/myproject' -MergeRequestId 15 -NoteId 200
```

Deletes note 200 from merge request !15 in the specified project.
...
- [Update-GitlabMergeRequestNote](Update-GitlabMergeRequestNote.md)
