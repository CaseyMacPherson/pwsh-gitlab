...
### Example 2: Update a comment on a merge request in a specific project

```powershell
Update-GitlabMergeRequestNote -ProjectId 'mygroup/myproject' -MergeRequestId 15 -NoteId 200 -Note 'No longer blocking.'
```

Replaces the body of note 200 on merge request !15 in the specified project.
...
- [Remove-GitlabMergeRequestNote](Remove-GitlabMergeRequestNote.md)
