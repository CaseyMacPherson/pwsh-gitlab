...
### Example 2: Delete a comment from an issue in a specific project

```powershell
Remove-GitlabIssueNote -ProjectId 'mygroup/myproject' -IssueId 15 -NoteId 200
```

Deletes note 200 from issue #15 in the specified project.
...
- [Update-GitlabIssueNote](Update-GitlabIssueNote.md)
